<div class="user-sidebar">
    ...
    <div class="d-lg-none" style="z-index:3;">
        <ul class="topbar-action-list">
            <li class="topbar-action-item topbar-action-link">
                <a href="https://qtfx"><em class="ti ti-home"></em> Home</a>
    ...
    <ul class="user-icon-nav">
        ...
        <li>
            <a href="plan.php"><em class="ti ti-import"></em>Plans</a>
        </li>
        <li>
            <a href="user-list.php"><em class="ti ti-import"></em>List Users</a>
        </li>
        ...
        <li><a href="mail-user.php"><em class="ti ti-import"></em>Mail User</a></li>
    ...
    <ul class="user-nav">
        <li>Contact Support<span>support@qtfx.space</span></li>
    </ul><!-- .user-nav -->
</div><!-- .user-sidebar -->